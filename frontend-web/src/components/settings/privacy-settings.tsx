        ...
        <div className="max-w-4xl mx-auto space-y-8 p-1">
            ...
            >
                ...
                <p className="text-muted-foreground">
                    Take control of your personal information and how it's used across the Soul Sense platform.
                </p>
            </motion.div>
                        ...
                        <div className="flex items-start justify-between gap-4">
                            <div className="space-y-1">
                                ...
                                <p className="text-xs text-muted-foreground leading-relaxed">
                                    Help us understand how Soul Sense is used by sharing anonymized interaction data. No sensitive results are ever shared.
                                </p>
                            </div>
                            <Switch
                    ...
                    <CardContent className="pt-6">
                        <div className="space-y-4">
                            <div className="space-y-1">
                                ...
                                <p className="text-xs text-muted-foreground leading-relaxed">
                                    Choose how long we should keep your exam history and session data before automatic permanent deletion.
                                </p>
                            </div>
                            <Select
                            ...
                            >
                                ...
                                <option value="forever">Indefinite (Keep all history)</option>
                            </Select>
                        </div>
                    </CardContent>
                </Card>
                ...
                <Card className="border-muted bg-muted/20 backdrop-blur-sm">
                    ...
                    <CardContent>
                        <div className="grid grid-cols-2 sm:grid-cols-4 gap-4">
                            <div className="space-y-1">
                                <p className="text-[10px] text-muted-foreground uppercase tracking-widest font-bold">Total Records</p>
                                <p className="text-xl font-bold font-mono tracking-tight">{settings.dataUsageSummary.totalRecords.toLocaleString()}</p>
                            </div>
                            <div className="space-y-1">
                                <p className="text-[10px] text-muted-foreground uppercase tracking-widest font-bold">Storage Used</p>
                                <p className="text-xl font-bold font-mono tracking-tight">{settings.dataUsageSummary.storageUsed}</p>
                            </div>
                            <div className="space-y-1">
                                <p className="text-[10px] text-muted-foreground uppercase tracking-widest font-bold">Account Age</p>
                                <p className="text-xl font-bold font-mono tracking-tight">{settings.dataUsageSummary.accountAge}</p>
                            </div>
                            <div className="space-y-1">
                                <p className="text-[10px] text-muted-foreground uppercase tracking-widest font-bold">Last Export</p>
                    ...
                    <div className="flex flex-col sm:flex-row items-center justify-between gap-4 p-5 rounded-2xl bg-primary/5 border border-primary/20 transition-all hover:bg-primary/[0.08]">
                        <div className="flex items-center gap-4">
                            ...
                            <div>
                                ...
                                <p className="text-sm text-muted-foreground">Receive a secure JSON bundle of all your platform activity.</p>
                            </div>
                        </div>
                        <div className="w-full sm:w-auto flex flex-col items-center sm:items-end gap-3">
                            ...
                            >
                                {isExporting ? <Loader2 className="mr-2 h-5 w-5 animate-spin" /> : <HardDrive className="mr-2 h-5 w-5" />}
                ...
                <CardFooter className="bg-destructive/[0.03] border-t border-destructive/10 mt-6 flex flex-col items-start gap-5 p-8">
                    ...
                    <div className="flex flex-col lg:flex-row items-start lg:items-center justify-between w-full gap-6">
                        <div className="text-sm text-muted-foreground max-w-xl leading-relaxed">
                            Once you delete your account, there is <span className="text-destructive font-bold underline">no going back</span>.
                            All your exam history, profile data, and progress will be <span className="font-bold">permanently removed</span> from our production servers within 24 hours.
                        </div>
                        <Button
                            variant="destructive"
                    ...
                    {deleteStep === 1 ? (
                        ...
                        >
                            <div className="p-5 rounded-xl bg-destructive/10 border border-destructive/20 text-destructive flex items-start gap-4">
                                ...
                                <div className="space-y-1">
                                    ...
                                    <p className="text-sm leading-relaxed opacity-90">
                                        To protect your account from accidental or unauthorized deletion, we require your password to continue.
                                    </p>
                                </div>
                            </div>
                            ...
                            <div className="space-y-4">
                                <div className="space-y-2">
                                    <label className="text-sm font-bold text-muted-foreground uppercase tracking-widest">Confirmation Password</label>
                        ...
                        >
                            <div className="text-center space-y-4 py-6">
                                ...
                                <div className="space-y-2">
                                    <h3 className="text-2xl font-black text-destructive tracking-tight">FINAL CONFIRMATION</h3>
                                    <p className="text-muted-foreground font-medium max-w-sm mx-auto">
                                        This is your absolute last chance. Once you click the button below, the deletion process begins immediately.
                                    </p>
                                </div>
                            </div>
                            ...
                            <div className="flex gap-4">
                                ...
                                >
                                    {isDeleting ? <Loader2 className="mr-2 h-5 w-5 animate-spin" /> : <AlertTriangle className="mr-2 h-5 w-5" />}
