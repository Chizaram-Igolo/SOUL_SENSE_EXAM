...
import { NotificationSettings, NotificationSettingsObject } from '@/components/settings/notification-settings';
        ...
        <div className="min-h-screen bg-background py-12 px-4">
            <div className="max-w-4xl mx-auto space-y-12">
                <div className="text-center space-y-4">
                    ...
                    <p className="text-muted-foreground text-lg">Testing the Notification Preferences interface</p>
                </div>
